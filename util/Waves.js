...
function arbitraryScale(element, relativeX, relativeY) {
    const $elem = (0, jquery_1.default)(element);
...
function factory() {
    ...
    const Effect = {
        ...
        show(event, element) {
            ...
            if ((0, jquery_1.default)(element).hasClass("waves-ink")) {
        ...
        hide(event, element) {
            ...
            if (isTouchAvailable) {
                (0, jquery_1.default)(element).off("touchend")
                    .on("touchend", function (event) {
                    Effect.hide(event, this);
                });
                (0, jquery_1.default)(element).off("touchcancel")
                    .on("touchcancel", function (event) {
                    Effect.hide(event, this);
                });
            }
            (0, jquery_1.default)(element).off("mouseup")
                .on("mouseup", function (event) {
                Effect.hide(event, this);
            });
            (0, jquery_1.default)(element).off("mouseleave")
