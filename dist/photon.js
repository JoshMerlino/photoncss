...
!function(t) {
    var e = function() {
        "use strict";
        var e = e || {}, n = document.querySelectorAll.bind(document), o = Object.prototype.toString, a = "ontouchstart" in t;
        function i(t) {
            var e = typeof t;
        ...
        function s(t) {
            ...
            return e = a.documentElement, void 0 !== t.getBoundingClientRect && (o = t.getBoundingClientRect()), 
            n = function(t) {
        ...
        var c = {
            ...
            show: function(t, e, n) {
                ...
                var a = s(e), i = 0, r = 0;
                "touches" in t && t.touches.length ? (i = t.touches[0].pageY - a.top, r = t.touches[0].pageX - a.left) : (i = t.pageY - a.top, 
                r = t.pageX - a.left), r = r >= 0 ? r : 0, i = i >= 0 ? i : 0;
                var l = "scale(" + Photon.Waves.calc(e, r, i) + ")", d = "translate(0,0)";
                n && (d = "translate(" + n.x + "px, " + n.y + "px)"), o.setAttribute("data-hold", Date.now()), 
                o.setAttribute("data-x", r), o.setAttribute("data-y", i), o.setAttribute("data-scale", l), 
                o.setAttribute("data-translate", d);
                var f = {
                    top: i + "px",
                    left: r + "px"
                };
                o.classList.add("waves-notransition"), o.setAttribute("style", u(f)), o.classList.remove("waves-notransition"), 
                f["-webkit-transform"] = l + " " + d, f["-moz-transform"] = l + " " + d, f["-ms-transform"] = l + " " + d, 
                f["-o-transform"] = l + " " + d, f.transform = l + " " + d;
                var v = "mousemove" === t.type ? 750 : c.duration;
                f["-webkit-transition-duration"] = v + "ms", f["-moz-transition-duration"] = v + "ms", 
                f["-o-transition-duration"] = v + "ms", f["transition-duration"] = v + "ms", o.setAttribute("style", u(f));
            },
            hide: function(t, e) {
                for (var n = (e = e || this).getElementsByClassName("waves-rippling"), o = 0, i = n.length; o < i; o++) d(t, e, n[o]);
                a && (e.removeEventListener("touchend", c.hide), e.removeEventListener("touchcancel", c.hide)), 
                e.removeEventListener("mouseup", c.hide), e.removeEventListener("mouseleave", c.hide);
            }
        }, l = {
            input: function(e) {
                var n = e.parentNode;
                if ("i" !== n.tagName.toLowerCase() || !n.classList.contains("waves-effect")) {
                    ...
                    o.className = e.className + " waves-input-wrapper", e.className = "waves-button-input", 
                    n.replaceChild(o, e), o.appendChild(e);
                    var a = t.getComputedStyle(e, null), i = a.color, r = a.backgroundColor;
        ...
        function d(t, e, n) {
            if (n) {
                ...
                var o = n.getAttribute("data-x"), a = n.getAttribute("data-y"), i = n.getAttribute("data-scale"), r = n.getAttribute("data-translate"), s = (Date.now(), 
                Number(n.getAttribute("data-hold")), 0);
        ...
        function v(t) {
            ...
            if (null !== e) {
                ...
                } else c.show(t, e), a && (e.addEventListener("touchend", c.hide, !1), e.addEventListener("touchcancel", c.hide, !1)), 
                e.addEventListener("mouseup", c.hide, !1), e.addEventListener("mouseleave", c.hide, !1);
            }
        }
        return e.init = function(t) {
            var e = document.body;
            "duration" in (t = t || {}) && (c.duration = t.duration), "delay" in t && (c.delay = t.delay), 
            a && (e.addEventListener("touchstart", v, !1), e.addEventListener("touchcancel", f.registerEvent, !1), 
            e.addEventListener("touchend", f.registerEvent, !1)), e.addEventListener("mousedown", v, !1);
        }, e.attach = function(t, e) {
            var n, a;
            t = r(t), "[object Array]" === o.call(e) && (e = e.join(" ")), e = e ? " " + e : "";
            for (var i = 0, s = t.length; i < s; i++) a = (n = t[i]).tagName.toLowerCase(), 
            -1 !== [ "input", "img" ].indexOf(a) && (l[a](n), n = n.parentElement), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + e);
            ...
            if ((e = e || {}).wait = e.wait || 0, e.position = e.position || null, n) for (var o, a, i, u = {}, l = 0, d = {
                ...
                x: o.clientWidth / 2,
                y: o.clientHeight / 2
            }, i = s(o), u.x = i.left + a.x, u.y = i.top + a.y, d.pageX = u.x, d.pageY = u.y, 
            c.show(d, o), e.wait >= 0 && null !== e.wait) {
                setTimeout(f({
                    type: "mouseup",
                    button: 1
                }, o), e.wait);
    ...
    $(function() {
        $(".waves-effect").on("touchstart", function(t) {
            var e = t.targetTouches[0].pageX - $(this).offset().left, n = t.targetTouches[0].pageY - $(this).offset().top;
            Waves.ripple(this, {
                wait: 1e10,
        ...
        let methods = {
            init: function(options) {
                ...
                return this.each(function(i) {
                    ...
                    let $this = $(this), window_width = $(window).width();
                    let $active, $content, $links = $this.find("li.tab a"), $tabs_width = $this.width(), $tabs_content = $(), $tabs_wrapper, $tab_width = Math.max($tabs_width, $this[0].scrollWidth) / $links.length, $indicator, index = 0, prev_index = 0, clicked = false, clickedTimeout, transition = Photon.speed;
            ...
            if (this.options.type == "alert") {
                ...
                let repop = (cal, date) => {
                    ...
                    for (let i = 0; i < date.getDate() + 1; i++) {
                        ...
                        if (current.getTime() > now.getTime() + 864e5 && !opts.future) classes.push("disabled");
