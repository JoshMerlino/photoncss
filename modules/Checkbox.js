  ...
  _createClass(Checkbox, [{
    ...
    value: function serialize() {
      ...
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["color", "disabled", "waves"]);

      this.rest = rest;
      requestAnimationFrame(function () {
        return $("input#".concat(_this.props.id)).unbind().change(_this.props.onChange);
      });
      return ["checkbox"].concat(_toConsumableArray((rest.className || "").split(" ")), [color, disabled ? "disabled" : ""]).join(" ").replace(/\s+(?=\s)/g, "").trim();
    } // Render component
