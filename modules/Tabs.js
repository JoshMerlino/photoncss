...
exports.TabContent = exports.Tab = exports.Tabs = void 0;
  ...
  _createClass(Tabs, [{
    ...
    value: function serialize() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["color", "variant"]);

      this.rest = rest;
      return ["tabs", color, variant ? variant : ""].concat(_toConsumableArray((rest.className || "").split(" "))).join(" ").replace(/\s+(?=\s)/g, "").trim();
    } // Render component
...
var Tab = /*#__PURE__*/function (_React$Component2) {
...
var TabContent = /*#__PURE__*/function (_React$Component3) {
  _inherits(TabContent, _React$Component3);

  var _super3 = _createSuper(TabContent);
  ...
  _createClass(TabContent, [{
    ...
    value: function serialize() {
      ...
      this.rest = rest;
      return ["tab-content"].concat(_toConsumableArray((rest.className || "").split(" "))).join(" ").replace(/\s+(?=\s)/g, "").trim();
    } // Render component
