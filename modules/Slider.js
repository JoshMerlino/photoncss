  ...
  _createClass(Slider, [{
    ...
    value: function serialize() {
      var _this$props = this.props,
          ...
          rest = _objectWithoutProperties(_this$props, ["color", "leadingIcon", "trailingIcon"]);

      this.rest = rest;
      return ["slider"].concat(_toConsumableArray((rest.className || "").split(" ")), [color]).join(" ").replace(/\s+(?=\s)/g, "").trim();
    } // Render component
