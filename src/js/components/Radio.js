...
/* ****************************************** */
function Radio(_a) {
    var children = _a.children, labelPosition = _a.labelPosition, color = _a.color, waves = _a.waves, style = _a.style, id = _a.id, _b = _a.className, className = _b === void 0 ? "" : _b, props = __rest(_a, ["children", "labelPosition", "color", "waves", "style", "id", "className"]);
