	...
	$.fn.autolink = function(){
		this.each(function(){
			if(!$(this).hasClass("photon-init")){
				...
				$.ajax({
				    url: Photon.API + "service/api/pageinfo",
					type:"POST",
					data:{
						"url":href
					},
