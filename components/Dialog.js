...
function Dialog({ children, type, transition, size, className = "", ...props }) {
    const classes = (0, classnames_1.default)("photon-dialog", `size-${size}`, `transition-${transition}`, `type-${type}`, className);
...
function DialogTitle({ children, subtitle, seperated, className = "", ...props }) {
    const classes = (0, classnames_1.default)("dialog-title", seperated && "seperated", className);
...
function DialogActions({ children, direction, seperated, className = "", ...props }) {
    const classes = (0, classnames_1.default)("dialog-actions", `direction-${direction}`, seperated && "seperated", className);
    return react_1.default.createElement("div", { className: classes, ...props }, children);
}
...
function DialogBody({ children, className = "", ...props }) {
    const classes = (0, classnames_1.default)("dialog-body", className);
    return react_1.default.createElement("div", { className: classes, ...props }, children);
}
