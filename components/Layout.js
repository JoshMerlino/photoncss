...
function Container({ children, className, ...props }) {
    const classes = (0, classnames_1.default)("container", className);
...
function Row({ children, className, ...props }) {
    const classes = (0, classnames_1.default)("row", className);
    return react_1.default.createElement("div", { className: classes, ...props }, children);
}
exports.Row = Row;
Row.propTypes = {
...
function Col({ children, sm, md, lg, xl, className, ...props }) {
    const classes = (0, classnames_1.default)("col", sm && `s${sm}`, `m${md}`, `l${lg}`, `xl${xl}`, className);
    return react_1.default.createElement("div", { className: classes, ...props }, children);
}
exports.Col = Col;
Col.propTypes = {
...
function VHCenter({ children, className, ...props }) {
    const classes = (0, classnames_1.default)("vh-center", className);
    return react_1.default.createElement("div", { className: classes, ...props }, children);
}
