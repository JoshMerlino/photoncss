...
function Radio({ children, labelPosition, color, waves, style, id, className = "", ...props }) {
    const classes = (0, classnames_1.default)("photon-radio", `color-${color}`, `labelposition-${labelPosition}`, className);
    ...
    return (react_1.default.createElement("div", { className: classes, ...{ style } },
        ...
        react_1.default.createElement("input", { tabIndex: 0, type: "radio", id: id, ...props }),
